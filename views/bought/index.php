...
<div id="content-wrapper">
    ...
    <div class="panel">
        <div class="panel-heading">
            <span class="panel-title">Создать новый купленный товар</span>
        </div>
        <div class="panel-body">
            <form method="post" action="<? echo URL; ?>bought/create" class="form">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <!--@TODO:  -->
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <table class="table table-hover" style="font-size: 13px;">
                ...
                <tbody>
                <?php
                foreach ($this->boughtList as $key => $value): ?>
                <?php
